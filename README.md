...
The Projects view offers a list of *projects*, which are JSON files that contain the markdown text file, you're working with as well as the source data you input.
...
#### (Go to) Exports 
This sends you to the Exports view, on which more below.

#### Pin
This feature allows you to pin favorite or current projects to the top of the list for quick access and editing.
...
The editor view allows you to work on the text of your project using the markdown syntax. I will treat the options the editor view offers below, starting with standard text editor fare and moving onto distinct features.
...
This option, which can be triggered from the palette, inserts a bibliography of all of the projects's sources at the cursor. The ideal usage is triggering this option when your work is finished to insert a bibliography under a heading which will then be picked up by the export feature.
...
This will open a pop-up from which you can fuzzy search your projects' sources and insert a full footnote citation. Combined with the bibliography feature, this deals with all of the citation work a high school student might need to do.
...
Manuscripts has a built-in citation manager that will open a modal where students may enter and manage works on a per project basis (though you can also import sources from other projects as well). The types of sources supported at present are books, book sections, articles, and websites.
...
From the exports view, you may see and search .md, .docx, and .pdf that you have created from projects, and submit or print a .pdf by pressing enter.
...
You can then designate the receiver on your writerdeck.
...
If a password has been set, you'll have an opportunity to enter it; and then the receiver app will receive the file.
